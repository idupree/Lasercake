...
std::string robot::player_instructions()const {
  const std::string instructions = (
      ...
      (mode_ == "building_conveyor") ? "Conveyor mode: Click to build a conveyor belt (costs "+draw_m3(conveyor_cost)+") or click a conveyor to rotate it. Conveyors move rubble/metal only." :
