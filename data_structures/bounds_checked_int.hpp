...
inline constexpr bounds_checked_int<uint32_t> lossless_multiply(bounds_checked_int<uint16_t> a1, bounds_checked_int<uint16_t> a2) { return (uint32_t)a1.get() * a2.get(); }
inline constexpr bounds_checked_int<int32_t> lossless_multiply(bounds_checked_int<int16_t> a1, bounds_checked_int<int16_t> a2) { return (int32_t)a1.get() * a2.get(); }

inline constexpr bounds_checked_int<uint64_t> lossless_multiply(bounds_checked_int<uint32_t> a1, bounds_checked_int<uint32_t> a2) { return (uint64_t)a1.get() * a2.get(); }
inline constexpr bounds_checked_int<int64_t> lossless_multiply(bounds_checked_int<int32_t> a1, bounds_checked_int<int32_t> a2) { return (int64_t)a1.get() * a2.get(); }

// Hack - don't return it bounds-checked, because we can't bounds-check it without an int256.
inline uint128 lossless_multiply(bounds_checked_int<uint64_t> a1, bounds_checked_int<uint64_t> a2) { return lossless_multiply(a1.get(), a2.get()); }
inline int128 lossless_multiply(bounds_checked_int<int64_t> a1, bounds_checked_int<int64_t> a2) { return lossless_multiply(a1.get(), a2.get()); }
